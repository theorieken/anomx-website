...
export function HomePage() {
    ...
    useEffect(() => {
        ...
        let frame = 0;
        const update = () => { frame = 0; const progress = Math.min(1, Math.max(0, -element.getBoundingClientRect().top / (element.offsetHeight * .8))); element.style.setProperty("--hero-progress", String(progress)); };
    ...
    return <Experience>
        <section className="cinematic-hero" ref={hero}>
            ...
            <div className="hero-art"><Image src="/media/intelligence-sculpture.webp" alt="" width={1920} height={1080} priority sizes="100vw" /><HeroSignals /></div>
